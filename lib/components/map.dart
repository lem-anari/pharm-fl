...
//    setGeolocation(applicationBloc);
    ...
    return Scaffold(
        ...
        //     create: (context) => ApplicationBloc(), // должно біть в home
        //     child: Scaffold(
